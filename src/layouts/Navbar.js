		...
		<>
			<nav className='main-navbar py-1 bg-white border-bottom d-flex align-items-center shadow-sm'>
				<div className='container-fluid d-flex align-items-center'>
					<button
						type='button'
						className='d-flex align-items-center border-0 bg-transparent fs-3 p-0'
					...
					<Dropdown as={NavItem} className='ms-auto'>
						<Dropdown.Toggle
							as={NavLink}
							id='dropdown-user'
							className={`d-flex align-items-center p-2 dropdown-toggle-none`}
						>
							<CustomImage className='rounded-circle' src='/images/logo.png' width={34} height={34} alt='' />
						</Dropdown.Toggle>
						<Dropdown.Menu align={'end'} className='p-0 dropdown-menu-end shadow-sm'>
							<Dropdown.Item href='/'>
								<span className='d-block h6 mb-0'>Le Hieu</span>
								<small className='text-secondary'>@hieu17dth</small>
							</Dropdown.Item>
