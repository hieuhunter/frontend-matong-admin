...
import styles from './ImageInput.styles.module.scss';
					...
					<div className=''>
						<button type='button' className='btn btn-outline-secondary position-relative'>
							<input
								...
								className={`position-absolute w-100 ${styles.input__image}`}
							/>
				...
				{loadImg && (
					<div className='d-flex flex-column flex-sm-row mt-2 mt-md-0'>
						<div className='me-0 mb-2 mb-sm-0 me-sm-2'>
							<CustomImage className='' src={loadImg} width={350} height={150} alt='Image alt' />
						</div>
